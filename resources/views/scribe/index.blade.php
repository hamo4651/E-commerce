                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-PUTapi-orders--id--status">PUT api/orders/{id}/status</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-stripe-payment">
                                <a href="#endpoints-POSTapi-stripe-payment">POST api/stripe/payment</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-paypal-payment">
                                <a href="#endpoints-POSTapi-paypal-payment">POST api/paypal/payment</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-paypal-capture">
                                <a href="#endpoints-POSTapi-paypal-capture">POST api/paypal/capture</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="bash-example">
    ...
    --form "is_admin=1"\
    --form "image=@/tmp/phppgocpA" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phppgocpA</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --form "image=@/tmp/phppLedHD" </code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_en"                data-endpoint="POSTapi-categories"
               value="architecto"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_ar"                data-endpoint="POSTapi-categories"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phppLedHD</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --form "description_en=architecto"\
    --form "description_ar=architecto"\
    --form "image=@/tmp/phpDiMlaD" </code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name_en"                data-endpoint="PUTapi-categories--id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name_ar"                data-endpoint="PUTapi-categories--id-"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_en"                data-endpoint="PUTapi-categories--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_ar"                data-endpoint="PUTapi-categories--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpDiMlaD</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/products/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    ...
    --form "description_ar=architecto"\
    --form "price=22"\
    --form "discounted_price=67"\
    --form "quantity=16"\
    --form "status=active"\
    --form "images[]=@/tmp/phpOEnKOE" </code></pre></div>
...
body.append('discounted_price', '67');
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name_en"                data-endpoint="POSTapi-products"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name_ar"                data-endpoint="POSTapi-products"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_en"                data-endpoint="POSTapi-products"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_ar"                data-endpoint="POSTapi-products"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="discounted_price"                data-endpoint="POSTapi-products"
               value="67"
               data-component="body">
    <br>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>not active</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="category_id[0]"                data-endpoint="POSTapi-products"
               data-component="body">
        <input type="text" style="display: none"
               name="category_id[1]"                data-endpoint="POSTapi-products"
               data-component="body">
    <br>
...
<div class="bash-example">
    ...
    --form "discounted_price=4326.41688"\
    --form "quantity=16"\
    --form "status=not active"\
    --form "images[]=@/tmp/phpmgLpeE" </code></pre></div>
...
body.append('discounted_price', '4326.41688');
body.append('quantity', '16');
body.append('status', 'not active');
body.append('images[]', document.querySelector('input[name="images[]"]').files[0]);
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name_en"                data-endpoint="PUTapi-products--id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name_ar"                data-endpoint="PUTapi-products--id-"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_en"                data-endpoint="PUTapi-products--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_ar"                data-endpoint="PUTapi-products--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="discounted_price"                data-endpoint="PUTapi-products--id-"
               value="4326.41688"
               data-component="body">
    <br>
<p>Example: <code>4326.41688</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>not active</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>not active</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="category_id[0]"                data-endpoint="PUTapi-products--id-"
               data-component="body">
        <input type="text" style="display: none"
               name="category_id[1]"                data-endpoint="PUTapi-products--id-"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table.</p>
        </div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/cart/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"quantity\": 16
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/orders/architecto/status" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the order. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-stripe-payment">POST api/stripe/payment</h2>
...
<span id="example-requests-POSTapi-stripe-payment">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-stripe-payment">
</span>
<span id="execution-results-POSTapi-stripe-payment" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-stripe-payment"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-stripe-payment"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-stripe-payment" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-stripe-payment">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-stripe-payment" data-method="POST"
      data-path="api/stripe/payment"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-stripe-payment', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-stripe-payment"
                    onclick="tryItOut('POSTapi-stripe-payment');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-stripe-payment"
                    onclick="cancelTryOut('POSTapi-stripe-payment');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-stripe-payment"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/stripe/payment</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-stripe-payment"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-stripe-payment"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_number"                data-endpoint="POSTapi-stripe-payment"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>order_number</code> of an existing record in the orders table. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="token"                data-endpoint="POSTapi-stripe-payment"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-paypal-payment">POST api/paypal/payment</h2>
...
<span id="example-requests-POSTapi-paypal-payment">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-paypal-payment">
</span>
<span id="execution-results-POSTapi-paypal-payment" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-paypal-payment"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-paypal-payment"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-paypal-payment" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-paypal-payment">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-paypal-payment" data-method="POST"
      data-path="api/paypal/payment"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-paypal-payment', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-paypal-payment"
                    onclick="tryItOut('POSTapi-paypal-payment');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-paypal-payment"
                    onclick="cancelTryOut('POSTapi-paypal-payment');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-paypal-payment"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/paypal/payment</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-paypal-payment"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-paypal-payment"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_number"                data-endpoint="POSTapi-paypal-payment"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>order_number</code> of an existing record in the orders table. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-paypal-capture">POST api/paypal/capture</h2>
...
<span id="example-requests-POSTapi-paypal-capture">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/paypal/capture" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"order_id\": \"architecto\",
...
<span id="example-responses-POSTapi-paypal-capture">
</span>
<span id="execution-results-POSTapi-paypal-capture" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-paypal-capture"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-paypal-capture"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-paypal-capture" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-paypal-capture">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-paypal-capture" data-method="POST"
      data-path="api/paypal/capture"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-paypal-capture', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-paypal-capture"
                    onclick="tryItOut('POSTapi-paypal-capture');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-paypal-capture"
                    onclick="cancelTryOut('POSTapi-paypal-capture');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-paypal-capture"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/paypal/capture</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-paypal-capture"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-paypal-capture"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_id"                data-endpoint="POSTapi-paypal-capture"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_number"                data-endpoint="POSTapi-paypal-capture"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>order_number</code> of an existing record in the orders table. Example: <code>architecto</code></p>
